...
const BannerRight = () => (
  <div className="contact_banner-right">
    <svg
      aria-label="Contact banner countryside"
    ...
    >
      ...
      <desc>countryside</desc>
      <g className="contact__banner-right-windmill">
        <g className="contact__banner-right-windmill1_transform-rotate">
        ...
        />
        <g className="contact__banner-right-windmill2_transform-rotate">
      ...
      <path
        className="contact__banner-right-svg1"
      ...
      />
      <path
        className="contact__banner-right-svg3"
      ...
      />
      <path
        className="contact__banner-right-svg2 contact__banner-smoke"
      ...
      <g>
        <rect
          className="contact__banner-right-svg5"
          x="251.537"
          y="379.312"
          width="19.808"
          height="20.688"
        />
        <path
          className="contact__banner-right-svg0"
      ...
      <path
        className="contact__banner-right-svg2 contact__banner-cloud3"
